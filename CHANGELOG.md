...
- Added `POST /trips/{trip_id}/finalize` to compute and persist trip stats (distance, max/min/avg speed) from GPS points. ([#20](https://github.com/TechVibe-Dev/trip-trace-api/pull/20))
